...
|------|------------|---------------|----------------|---------|-------------------|
| Digital Corpus of Sanskrit (DCS) | https://github.com/OliverHellwig/sanskrit | not yet downloaded | | | |
