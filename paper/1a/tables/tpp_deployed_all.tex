...
\bottomrule
\end{tabular}
\caption{Deployed practice on S\=amayik test (prose), $n=2{,}417$ pairs. Columns as in Table~\ref{tab:tppdeployed}.}
...
\bottomrule
\end{tabular}
\caption{Deployed practice on S\=amayik test\_ood (prose, OOD), $n=4{,}047$ pairs. Columns as in Table~\ref{tab:tppdeployed}.}
...
\bottomrule
\end{tabular}
\caption{Deployed practice on Itih\=asa test (verse), $n=11{,}721$ pairs. Columns as in Table~\ref{tab:tppdeployed}.}
...
\bottomrule
\end{tabular}
\caption{Deployed practice on FLORES devtest, $n=1{,}012$ pairs. Columns as in Table~\ref{tab:tppdeployed}.}
